...
static const char loadedWifiEnabledFromNVS[] PROGMEM = "Wifi Aus/Einschalt verhalten aus NVS geladen";
static const char wroteWifiEnabledToNVS[] PROGMEM = "Wifi Aus/Einschalt verhalten wurde ins NVS geschrieben";
static const char wifiEnabledNotFoundInNVS[] PROGMEM = "Wifi Aus/Einschalt verhalten im NVS nicht gefunden";
static const char loadedStopWhenCardAway[] PROGMEM = "Verhalten bei Karte entfernen aus NVS geladen";
static const char stopWhenCardAwayNotFoundInNVS[] PROGMEM = "Verhalten bei Karte entfernen im NVS nicht gefunden";
static const char wroteStopWhenCardAwayToNVS[] PROGMEM = "Verhalten bei Karte entfernen ins NVS geschrieben";
